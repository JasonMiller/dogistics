defmodule DogisticsWeb.Router do
  use DogisticsWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {DogisticsWeb.LayoutView, :root}
  ...
  scope "/api", DogisticsWeb do
    ...
    get("/runs/:id/fetch_markers.geojson", API.RunController, :fetch_markers)
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: DogisticsWeb.Telemetry
    end
  end
end
